"""
Linear Probe Training + Test Prediction for Mini-ImageNet Kaggle Dataset
========================================================================
...
Pipeline:
    ...
    2. Extract features for TRAIN and TEST images.
    3. Train linear classifier using TRAIN labels.
...
Usage:
python linear_probe_train_and_predict.py \
    ...
    --test_csv /scratch/sp7007/cub/kaggle_data/test_images.csv \
    --test_dir /scratch/sp7007/cub/kaggle_data/test \
    --num_labels 200 \
    --epochs 34 \
    --batch_size 32 \
    --lr 0.0075 \
    ...
    --output_dir /scratch/sp7007/cubtest1
...
def extract_features(model, loader, device):
    ...
    model.eval()
    with torch.no_grad():
        for imgs, labs, fnames in tqdm(loader, desc="Extracting features"):
            imgs = imgs.to(device)
...
def main():
    parser = argparse.ArgumentParser(description="Linear Probe Training + Test Prediction")
    ...
    print("="*60)
    print("Linear Probe Training + Test Prediction")
    print("="*60)
    ...
    test_features, _, test_filenames = extract_features(model, test_loader, device)
